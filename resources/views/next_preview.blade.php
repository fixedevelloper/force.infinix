                    ...
                    <div class="flex flex-col space-y-10 sm:space-y-7.5">
                        ...
                        <div>
                            <div
                                ...
                                <div class="flex z-10 flex-wrap -m-2 sm:-mx-px mb-7.5 sm:justify-around"><a
                                        href="/dashboard/x3/1?user=1&amp;cycle=8733">
                                        <div
                                            ...
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 1</span></div>
                                    ...
                                    </a><a href="/dashboard/x3/2?user=1&amp;cycle=1188">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 2</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">2519</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">1187</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/3?user=1&amp;cycle=416">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 3</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">781</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">415</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/4?user=1&amp;cycle=198">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 4</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>40</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">340</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">197</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/5?user=1&amp;cycle=91">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 5</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>80</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">151</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">90</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/6?user=1&amp;cycle=48">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 6</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>160</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">74</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">47</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/7?user=1&amp;cycle=25">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 7</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>320</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">39</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">24</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/8?user=1&amp;cycle=17">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 8</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>640</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">26</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">16</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/9?user=1&amp;cycle=10">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 9</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>1 250</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                ...
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">9</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/10?user=1&amp;cycle=7">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 10</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>2 500</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">10</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">6</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/11?user=1&amp;cycle=5">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 11</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>5 000</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">8</span>
                                                </div>
                                                <div class="flex space-x-2 items-center">
                                                    <svg class="w-5 h-5 stroke-current text-white-500"
                                                         viewBox="0 0 20 20" fill="none" stroke="#2CFF4E"
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">4</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a><a href="/dashboard/x3/12?user=1&amp;cycle=3">
                                        <div
                                            class="relative overflow-hidden flex flex-col w-180px min-h-158px max-h-[158px] sm:w-158px rounded-small p-5 m-2 justify-between bg-main-blue hover:bg-hover-main-blue sm:space-y-1.5">
                                            <div class="flex w-full justify-between !mb-2.5">
                                                <div class="flex space-x-1.5 items-center"><span
                                                        class="text-white-500 text-base sm:text-sm">Lvl 12</span></div>
                                                <span class="flex items-center text-white text-base sm:text-sm"><svg
                                                        class="w-3 h-3 mr-1.5" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24"
                                                                                                 rx="12"
                                                                                                 fill="#F3BA2F"></rect><path
                                                            d="m12 4.32 1.903 1.943-4.791 4.777-1.903-1.897L12 4.32ZM14.889 7.2l1.902 1.943-7.68 7.657-1.902-1.897 7.68-7.703ZM6.223 10.08l1.903 1.943-1.903 1.897-1.903-1.897 1.903-1.943ZM17.777 10.08l1.903 1.943L12 19.68l-1.903-1.897 7.68-7.703Z"
                                                            fill="#fff" stroke="#F0B90B"></path></svg>9 900</span></div>
                                            <div class="relative flex flex-col -ml-2.5 -mr-2.5 !mb-3 ">
                                                <div class="flex w-full justify-center items-center">
                                                    <div class="relative flex w-full justify-evenly items-start false">
                                                        <div class="flex w-full">
                                            ...
                                            <div class="flex flex-wrap space-x-2">
                                                ...
                                                <div class="flex space-x-2 items-center">
                                                    ...
                                                    <span class="text-sm text-white font-normal sm:text-sm">2</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a></div>
